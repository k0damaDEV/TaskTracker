...
class UsersControllerTest {
    ...
    void init() throws Exception {
        userToCreateJson = testUtils.readFileContent(TestUtils.FIXTURES_PATH + "userToCreate.json");
        userToPatchJson = testUtils.readFileContent(TestUtils.FIXTURES_PATH + "userToPatch.json");
        userToCreateWithIncorrectCredentialsJson = testUtils.readFileContent(TestUtils.FIXTURES_PATH
